    ...
    <div style={styles.sidebar}>
      ...
      <div style={styles.columns}>
        ...
        <div style={styles.serverBar}>
          <div style={styles.serverBtn} onClick={() => navigate('/app')} title="Direct Messages">
            💬
          </div>
...
divider: {
  ...
  sectionBtn: {
    ...
    textAlign: 'left' as const, fontWeight: 500, fontSize: 14,
  },
  dmHeader: {
  ...
  meBlock: {
    borderTop: '1px solid #ddd', paddingTop: 8, marginTop: 8
  },
  meInfo: {
