...
func (d *Database) SaveAttachment(ctx context.Context, a models.Attachment) error {
	_, err := d.db.ExecContext(ctx,
		`INSERT INTO attachments (id, message_id, file_name, store_name, mime_type, size)
		 VALUES ($1, $2, $3, $4, $5, $6)`,
		a.ID, a.MessageID, a.FileName, a.StoreName, a.MimeType, a.Size,
	)
	if err != nil {
...
func (d *Database) GetAttachmentsByMessageIDs(ctx context.Context, messageIDs []string) (map[string][]models.Attachment, error) {
	...
	for rows.Next() {
		...
		if err := rows.Scan(&a.ID, &a.MessageID, &a.FileName, &a.StoreName, &a.MimeType, &a.Size); err != nil {
